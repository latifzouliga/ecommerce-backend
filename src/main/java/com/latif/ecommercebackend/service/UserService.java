...
public interface UserService {
    ...
    String LoginUser(LoginBody loginBody) throws EcommerceProjectException, UserNotVerifiedException, EmailFailureException, UserNotFoundException;

    void verifyUser(String token) throws UserNotVerifiedException;
}
